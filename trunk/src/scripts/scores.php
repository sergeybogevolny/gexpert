...
if ($_GET['show'] == 'all') {
    $cTestControllerObj->column = array("username" => "username", 'score', 'test_time', 'total_marks', 'total_questions', 'correct_answers', 'td.name', 'add_date');
    if ($_GET['id'] == "") {
    ...
    $cFormObj->options['column']['score'] = array('name' => "User Score", 'type' => "number", 'sort' => true, 'index' => 3, 'filter' => 'box');
    $cFormObj->options['column']['total_marks'] = array('name' => "Total Score", 'type' => "number", 'sort' => true, 'index' => 4, 'filter' => 'box');

    $cFormObj->options['column']['total_questions'] = array('name' => "Total Questions", 'type' => "string", 'sort' => true, 'index' => 6);
    $cFormObj->options['column']['correct_answers'] = array('name' => "Correct Answers", 'type' => "string", 'sort' => true, 'index' => 7);
    $cFormObj->options['column']['add_date'] = array("name" => 'Score Date', 'type' => "date", 'format' => AppDateFormatPhp, 'sort' => true, 'index' => 9, 'filter' => 'box');
    $cFormObj->options['column']['test_time'] = array('name' => "Test Time (Seconds)", 'type' => "string", 'sort' => true, 'index' => 8, 'filter' => 'box');
